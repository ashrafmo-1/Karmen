  ...
  return (
    <div>
      <section className="btns_cat flex items-center gap-12 justify-center">
        <Caterories_btn path={"/silverEarrings"} photo={product_9} title={"silver Watches"} />
        <Caterories_btn path={"/goldrings"} photo={gold} title={"Gold Watches"} />
        <Caterories_btn path={"/stackingrings"} photo={stacking} title={"Smart Watches"} />
      </section>
